            ...
            <tbody>
                @foreach ($menu as $p)
                    <tr>
                        ...
                        <td>{{ $p->nama_menu }}</td>
                        <td>{{ $p->harga }}</td>
                        <td><img width="50px" src="{{ asset('images') }}/{{ $p->image }}" alt=""
                                srcset=""></td>
                        <td>{{ $p->deskripsi }}</td>
                        <td>
                            <button class="btn text-warning" data-toggle="modal" data-target="#modalFormMenu"
                                data-mode="edit" data-id="{{ $p->id }}" data-jenis_id="{{ $p->jenis_id }}"
